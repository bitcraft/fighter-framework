...
class IK_Guy(autoblocker.AutoBlocker):
    ...
    def setup(self):
        ...
        # to block cancels
        fsa.add_transition(BUTTON_LOW_PUNCH, "high punch", "block",
                           flags=STICKY)
        ...
        # roundhouse combo
        fsa.add_combo("roundhouse", "low kick", "medium kick", "high kick",
                      "high kick")

        # bash button combo
        fsa.add_button_combo("dash forward", 500, BUTTON_FORWARD,
                             BUTTON_FORWARD)
